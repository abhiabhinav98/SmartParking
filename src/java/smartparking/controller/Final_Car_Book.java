...
/**
 * Servlet implementation class Final_Car_Book
 */
		...
		if(session!=null)
		{
			...
			if(park.equals("park"))
			{
				...
				try{
                                        ...
                                        //java.sql.Timestamp date1 = new java.sql.Timestamp (Long.parseLong(date_str));
					Class.forName("oracle.jdbc.OracleDriver");
                                        System.out.println("Driver Successfully loaded");
                                        Connection con=DriverManager.getConnection("jdbc:oracle:thin:@//LAPTOP-7OJKGVAD:1521/xe","smartparking","smart");
					java.sql.PreparedStatement s=con.prepareStatement("insert into parking_spot_info values(?,?,?,?,?,?)");
			...
			else
			{
				...
				try{
				    ...
				    System.out.println("In final car book : "+date1.toInstant());
				    System.out.println("In final car book : "+date1);
				    System.out.println("In final car book : "+temp.toString());
				    System.out.println("In final car book : "+hour);
				    
					Class.forName("oracle.jdbc.OracleDriver");
                                        System.out.println("Driver Successfully loaded");
                                        Connection con=DriverManager.getConnection("jdbc:oracle:thin:@//LAPTOP-7OJKGVAD:1521/xe","smartparking","smart");
					java.sql.PreparedStatement s=con.prepareStatement("insert into parking_spot_info values(?,?,?,?,?,'"+hour+":00:00')");
					s.setInt(1, Integer.parseInt(snum));
					s.setInt(2, Integer.parseInt(pnum));
					s.setInt(3, 1);
					s.setString(4, username);
