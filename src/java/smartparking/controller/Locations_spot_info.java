  ...
  /*  public Locations_spot_info(String l) {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String driver="com.mysql.jdbc.Driver";*/
                System.out.println("in locations_spot_info");
		String username;
		lcode_string= request.getParameter("lcode");
                System.out.println("lcode string from sign in customer "+lcode_string);
		...
		if(session!=null)
		{
			...
			out.print("<!DOCTYPE html><html><head><title>Smart Parking Services</title>"
					...
					+ "</head><body>");
			System.out.println("below out.println in locations spot info");
			
		try{
		Class.forName("oracle.jdbc.OracleDriver");
            System.out.println("Driver Successfully loaded in locations spot info");
		...
		r.next();
		out.println("<br> number of parking lots in "+r.getString(1)+":"+r.getInt(2));
		...
		while(r3.next())
		{
			...
			pnum=r3.getString(2);
			out.println(" <br><br><br><br><br><div class=\"container\"> <div class=\"col-md-6 images wow fadeInRight\" data-wow-delay=\"0.5s\">");
			//out.println("<input type=\"submit\" style=\"background-image: url('images/img"+((Integer.parseInt(pnum)+1)%6+2)+".png');\" height=\"200px\" width=\"200px\"  value=\""+pnum+"\" name=\"action\"><br></div>");
			out.println("<br><a href=\"Parking_spot_info?action="+pnum+"\"><img src=\"images/lot"+((Integer.parseInt(pnum)+1)%6+2)+".jpg\" height=\"200\" width=\"200\"></a>");
                        out.println("<br><div class=\"col-md-6 images wow fadeInRight\" data-wow-delay=\"0.5s\">");
